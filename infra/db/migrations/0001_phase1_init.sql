...
create table if not exists core.stadiums (
  id text primary key,
  slug text not null,
  name text not null,
  short_name text,
...
create table if not exists core.managers (
  id text primary key,
  slug text not null,
  name text not null,
  short_name text,
...
create table if not exists core.lineups (
  id text primary key,
...
create table if not exists core.player_career_teams (
  id text primary key,
  player text not null references core.players(id),
  team text not null references core.teams(id),
  source_player_id text not null,
...
create table if not exists staging.tournaments (
  id text primary key,
  slug text,
  name text,
  short_name text,
...
create table if not exists staging.player_career_teams (
  id text primary key,
  player text,
  team text,
  source_player_id text,
...
create table if not exists staging.player_match_stats (
  id text primary key,
  match text,
  team text,
  player text,
...
create table if not exists staging.team_match_stats (
  id text primary key,
  match text,
  team text,
  source_match_id text,
